...
export default function Home() {
  const ref = useRef();
  const closeModel = () => {
    ref.current.classList = 'p-6 bg-red-50 transition-all duration-300 border-l-4 border-red-500 rounded-r-lg -translate-y-5 opacity-0';
  ...
  return (
    <Master>
      <div className="py-8 px-6">
        ...
        <div className="p-6 bg-red-50 transition-all duration-300 border-l-4 border-red-500 rounded-r-lg" ref={ref}>
          <div className="flex items-center">
            <h3 className="text-red-800 font-medium">Example for Banner</h3>
            <button className="ml-auto p-4 border border-red-400" onClick={closeModel}>
              <svg className="text-red-800" width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
